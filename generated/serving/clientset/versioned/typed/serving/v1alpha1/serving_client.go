...
// ServingV1alpha1Client is used to interact with features provided by the serving.yatai.ai group.
type ServingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServingV1alpha1Client) BentoDeployments(namespace string) BentoDeploymentInterface {
