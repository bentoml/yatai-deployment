...
{{- printf "%s-env" (include "yatai-deployment.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- define "yatai-deployment.yataiApiToken" -}}
    {{- $secretObj := (lookup "v1" "Secret" .Release.Namespace (include "yatai-deployment.envname" .)) | default dict }}
